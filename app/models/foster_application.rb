...
class FosterApplication < ApplicationRecord
  def new
    @foster_application = FosterApplication.new
  end

  def create
    @foster_application = FosterApplication.new(adoption_application_params)
  ...
  def foster_application_params
    params.require(:foster_application).permit(:name_of_dog, :name, :age, :street_address, :city, :state, :zip, :phone, :work_phone,
                                               ...
                                               :additional_information, :drivers_license, :name_on_license, :drivers_license_state, additional_dog_activities: [])
  end
end
